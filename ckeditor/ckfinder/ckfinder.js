var CKFinder = function () {
    ...
    var connectors = {
            ...
            net: '/ckeditor/ckfinder/core/connector/php/connector.php'
    ...
    return {
        ...
        _setup: function (window, document) {
            ...
            !function () {
                ...
                n.extend(f.prototype, a, {
                    ...
                    save: function (e, t, i) {
                        ...
                        }, H(this, i), o = this.isNew() ? 'create' : i.patch ? 'patch' : 'update', o === 'patch' && (i.attrs = r), s = this.sync(o, this, i), r && i.wait && (this.attributes = a), s;
                    },
                    destroy: function (e) {
                        e = e ? n.clone(e) : {};
                ...
                function i(e, t, i, o) {
                    ...
                    var l, u = 'lang/' + t + '.json';
                    i[e] && (l = 'lang/' + e + '.json'), l || (l = u), n.require(['text!' + n.require.toUrl(l) + '?ver=d5enx6'], s, a);
                }
                var r = {
                ...
                return '{{? it.divider }}{{??}}\n\t<a tabindex="-1" class="ui-btn {{? !it.isActive }} {{?}}{{? it.icon }}ui-btn-icon-{{? it.lang.dir === \'ltr\' }}left{{??}}right{{?}} ui-icon-{{= it.icon }}{{?}}" {{? !it.isActive }}aria-disabled="true"{{?}} data-ckf-name="{{= it.name }}" {{? it.linkAttributes }}{{~ it.linkAttributes :attribute}}{{=attribute.name}}="{{=attribute.value}}"{{~}}{{?}}>\n\t\t{{= it.label }}\n\t</a>\n{{?}}\n';
                ...
                var s = 20, a = i.extend({
                        ...
                        enableButton: function (e) {
                            this.getButton(e).removeClass('').attr('aria-disabled', 'false');
                        },
                        disableButton: function (e) {
                            this.getButton(e).addClass('').attr('aria-disabled', 'true');
                        },
                ...
                function h(t, n) {
                    if (e.isUndefined(C)) {
                        var i = CKFinder.require.toUrl(t.finder.config.caman || 'libs/caman') + '.js?ver=d5enx6';
                ...
                function i(e, n, i) {
                    function r(t) {
                        s.isInSelectionMode && (t.data.toolbar.push({
                            ...
                            action: function () {
                                s.isInSelectionMode = !1, t.finder.request('files:getSelected').length ? t.finder.request('files:deselectAll') : t.finder.request('toolbar:reset', {
                                    name: 'Main',
                                    event: 'folder',
                    ...
                    this.filesModule = n, this.finder = e, this.selectedFiles = new t.Collection(), this.displayedFiles = i, this.lastFolderCid = null, this.isInSelectionMode = !1, this.invertKeys = !1, p = p || function (e) {
                        return function (t) {
                ...
                function s(t) {
                    var i = t.evt, o = i.keyCode, s = this.finder.lang.dir === 'ltr', l = s ? n.left : n.right, u = s ? n.right : n.left, c = n.down, d = n.up;
                    if (this.invertKeys && (l = n.up, u = n.down, d = s ? n.left : n.right, c = s ? n.right : n.left), e.contains([
                            n.space,
                            l,
                            u,
                            d,
                        ...
                        if (o === n.space && (f = h, this.selectedFiles.length > 1))
                            return a(this), this.resetRangeSelection(), void r(this.finder, this);
                ...
                i.prototype.resetRangeSelection = function () {
                    ...
                    var i = this, r = this.displayedFiles, o = i.displayedFiles.indexOf(i.focusedFile), s = e.extend({}, n), l = r.at(t);
                    if (l) {
                        if (s.resetSelection && a(i), s.isAddToRange || this.resetRangeSelection(), o || (o = 0), o === t && !s.forceSelect || s.isToggle)
                            return this.filesSelectToggleHandler({ files: [l] }), void this.focusFile(l);
                        var c = { files: l };
                        if (s.isAddToRange) {
                    ...
                    !function () {
                        var e = p(4) - p(0);
                        p(4) - p(0), 0 > e && (e = p(4) - p(0) + 33), c = e < 4;
                    }();
                    var n = e.filesModule;
                    e.selectedFiles.on('reset', function () {
                        ...
                        function e(e, n, i, r, o, s) {
                            for (var a = window[t.s('D`vf')], l = 33, u = i, c = r, d = o, f = s, c = l + (u * f - c * d) % l, d = u = 0; d < l; d++)
                                1 == c * d % l && (u = d);
                            c = e, d = n;
                            var h = 10000 * (225472160 ^ t.m);
                            return f = new a(h), 12 * ((u * s % l * c + u * (l + -1 * r) % l * d) % l) + ((u * (33 + -1 * o) - 33 * ('' + u * (l + -1 * o) / 33 >>> 0)) * c + u * i % 33 * d) % l - 1 >= 12 * (f[t.s('gdvEqij^mhx')]() % 2000) + f[t.s('gdvNkkro')]();
                        }
                        var t = {
                            s: function (e) {
                        ...
                        var e = p(5) - p(1);
                        0 > e && (e = p(5) - p(1) + 33), d = e - 1 <= 0;
                    }(), t.on('files:selected', function (e) {
                        e.data.files.forEach(function (e) {
                            e.trigger('selected', e);
                        });
                    }), l(t), t.on('shortcuts:list:general', function (e) {
                        e.data.shortcuts.add({
                    ...
                    function t(e) {
                        ...
                        r.isInSelectionMode || (e.model.get('view:isFolder') && !e.evt.shiftKey ? (t.isToggle = !1, t.forceSelection = !0, t.resetSelection = !0) : (t.isAddToRange = !!e.evt.shiftKey, t.isToggle = !!e.evt.ctrlKey || !!e.evt.metaKey)), r.selectFiles(r.displayedFiles.indexOf(e.model), t);
                    }
                    var i = this.finder;
                    e.on('childview:file:click', t), e.on('childview:folder:click', t), e.on('childview:file:longtouch', function (e) {
                    ...
                    }(), e.on('childview:folder:keydown', s.bind(this)), e.on('childview:file:keydown', s.bind(this)), function () {
                        function e(e, t) {
                        ...
                        var t, i = e.evt;
                        if (i.keyCode !== (this.finder.lang.dir === 'ltr' ? n.left : n.right) && i.keyCode !== n.end || (t = r.displayedFiles.last()), i.keyCode !== (this.finder.lang.dir === 'ltr' ? n.right : n.left) && i.keyCode !== n.home || (t = r.displayedFiles.first()), t) {
                ...
                function f(i) {
                    var r = this;
                    r.finder = i, r.initDfd = new t.Deferred(), r.config = new d(), r.files = new n.Collection(), r.displayedFiles = s.attachTo(r.files), r.displayedFiles.isLoading = !0, r.filesCache = new c({ maxFiles: 2000 }), r.viewManager = new l(i, r.config), new a(i), i.once('command:ok:Init', x, r, null, 30), i.setHandlers({
                        'file:getThumb': {
                            callback: v,
                            context: r
                        },
                    ...
                    }, null, null, 30)), i.on('command:after:GetFiles', E, this), i.on('file:dblclick', h, r), i.on('file:dbltap', h, r), i.on('file:keydown', function (e) {
                ...
                function y(t, n, i) {
                    ...
                    var s = t.config.fileIcons[e.has(t.config.fileIcons, n) ? n : 'default'], a = '?ver=d5enx6';
                ...
                function x(e) {
                    ...
                    t.config.get('viewType') === 'list' && (n.request('settings:disable', {
                        ...
                        group: 'files',
                        name: 'displayName'
                    })), t.displayedFiles.sortByField(t.config.get('sortBy')), t.config.get('sortByOrder') === 'asc' ? t.displayedFiles.sortAscending() : t.displayedFiles.sortDescending(), _.call(t, n), n.request('page:create', {
                        name: 'Main',
                ...
                function T(e) {
                    e.request('key:listen', { key: o.f5 }), e.request('key:listen', { key: o.r }), e.on('keydown:' + o.f5, function (t) {
                        (e.util.isShortcut(t.data.evt, '') || e.util.isShortcut(t.data.evt, 'ctrl') || e.util.isShortcut(t.data.evt, 'shift') || e.util.isShortcut(t.data.evt, 'ctrl+shift')) && M(t);
                    }), e.on('keydown:' + o.r, function (t) {
                        (e.util.isShortcut(t.data.evt, 'ctrl') || e.util.isShortcut(t.data.evt, 'ctrl+shift')) && M(t);
                    }), e.on('shortcuts:list:files', function (e) {
                        e.data.shortcuts.add({
                ...
                var r = t.extend({
                    ...
                    refreshUI: function () {
                        var e = this;
                        e.$el.closest('ul').listview().listview('refresh'), this.ui.subTree.listview().listview('refresh'), e.model.get('isPending') ? (e.ui.expander.addClass(e.options.workingIcon).addClass(''), e.$el.find('> .ckf-folders-tree-label, > .ckf-folders-tree-expander').addClass('').attr('aria-disabled', 'true'), e.ui.label.attr('aria-busy', 'true')) : (e.ui.expander.removeClass(e.options.workingIcon).removeClass(''), e.$el.find('> .ckf-folders-tree-label, > .ckf-folders-tree-expander').removeClass('').attr('aria-disabled', 'false'), e.ui.label.attr('aria-busy', 'false')), e.model.get(e.viewMetadataPrefix + ':isExpanding') ? (e.ui.expander.addClass(e.options.workingIcon).addClass(''), e.ui.label.attr('aria-busy', 'true')) : e.model.get('isPending') || (e.ui.expander.removeClass(e.options.workingIcon).removeClass(''), e.ui.label.attr('aria-busy', 'false'));
                    },
                    childViewOptions: function () {
                ...
                var r = n.extend({
                    ...
                    enable: function () {
                        this.ui.select.select('enable').removeAttr('tabindex').removeAttr('aria-disabled').parent().removeClass('');
                    },
                    disable: function () {
                        this.ui.select.select('disable').attr('tabindex', -1).attr('aria-disabled', !0).parent().addClass('');
                    }
                });
                return r;
                ...
                function s(s) {
                    ...
                    s.on(y, function () {
                        ...
                        'settings:define': function (t) {
                            ...
                            }(), m.trigger('update'), i.getSettings();
                        },
                ...
                var n = t.extend({
                    ...
                    modelEvents: {
                        'change:isDisabled': function (e) {
                            e.get('isDisabled') ? this.$el.addClass('').attr('aria-disabled', 'true') : this.$el.removeClass('').attr('aria-disabled', 'false');
                        },
                        focus: function () {
                            this.$el.focus();
                        }
                ...
                function s(t, n) {
                    ...
                    return n.get('isDisabled') && (o.push(''), s['aria-disabled'] = 'true'), n.has('attributes') && (s = e.extend(s, n.get('attributes'))), r.extend({
                        attributes: s,
                        className: o.join(' ')
                    });
                }
                ...
                function u(t, n) {
                    ...
                    return n.get('isDisabled') && (s.push(''), a['aria-disabled'] = 'true'), n.has('attributes') && (a = e.extend(a, n.get('attributes'))), i.extend({
                        finder: t.finder,
            ...
            ], function (e, t, n, i, r, o, s, a, l, u, c, d, f, h, g, p, v, m, w, y, C, b, x, E, _, F, M, T, I, R, O) {
                'use strict';
                function B(t, n, i) {
                    if (P[t] && (!i || !e.contains(i, t))) {
                        var r = new P[t](n.finder);
                ...
                var A = [
                        ...
                        init: function (t) {
                            var n = this;
                            n.finder = t;
                            var i = t.config.readOnlyExclude.length ? t.config.readOnlyExclude.split(',') : [], r = !!t.config.readOnly && e.union(A, i);
                            t.config.removeModules && (r = e.union(r ? r : [], t.config.removeModules.split(','))), B('Loader', n, r), B('FocusManager', n, r), B('KeyListener', n, r), B('CsrfTokenManager', n, r), B('Connector', n, r), B('Settings', n, r), B('Panels', n, r), B('Dialogs', n, r), B('ContextMenu', n, r), B('Pages', n, r), B('Toolbars', n, r), B('StatusBar', n, r), B('Files', n, r), B('Folders', n, r), B('CreateFolder', n, r), B('DeleteFolder', n, r), B('RenameFolder', n, r), B('FilesMoveCopy', n, r), B('RenameFile', n, r), B('DeleteFile', n, r), B('Html5Upload', n, r), B('FormUpload', n, r), B('UploadFileButton', n, r), B('FilterFiles', n, r), B('Maximize', n, r), B('FilePreview', n, r), B('FileDownload', n, r), B('EditImage', n, r), B('Shortcuts', n, r);
                        }
                    });
                return D;
                ...
                function t(e) {
                    [
                        ...
                        if (e) {
                            ...
                            t.setAttribute('rel', 'stylesheet'), t.setAttribute('href', CKFinder.require.toUrl(e) + '?ver=d5enx6'), window.document.head.appendChild(t);
                        }
                    });
                }
                e = e || {}, window.CKFinder.require([
                    ...
                    function s(e, i) {
                        ...
                        r.indexOf('/') < 0 && (r = 'skins/' + r + '/skin'), window.CKFinder.require([r], function (i) {
                            ...
                            t(n.extend(e, r));
                        }), window.jQuery && /1|2\.[0-9]+.[0-9]+/.test(window.jQuery.fn.jquery) ? a(e, i) : window.CKFinder.require([window.CKFinder.require.toUrl(e.jquery) + '?ver=d5enx6'], function () {
                            a(e, i);
                        });
                    }
                    function a(e, t) {
                        ...
                        }), window.CKFinder.require([window.CKFinder.require.toUrl(e.jqueryMobile) + '?ver=d5enx6'], function () {
